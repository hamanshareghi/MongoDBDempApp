...
public class ChoreDataAccess
{
    ...
    public async Task<List<ChoreModel>> GetAllChoreForUser(UserModel user)
    {
    ...
    {
        var choresCollections = ConnectToMongo<ChoreModel>(ChoreCollection);
        return choresCollections.InsertOneAsync(chore);
    }
